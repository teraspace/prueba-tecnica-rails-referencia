...
SELECT id, 10, 10.0000, '2026-01-01 08:00:00+00'::timestamptz FROM materials WHERE code = 'ALU-6063'
UNION ALL
SELECT id, 10, 4.0000, '2026-01-02 08:00:00+00'::timestamptz FROM materials WHERE code = 'ALU-6063'
UNION ALL
SELECT id, 20, 100.0000, '2026-01-01 08:00:00+00'::timestamptz FROM materials WHERE code = 'ALU-6063';
